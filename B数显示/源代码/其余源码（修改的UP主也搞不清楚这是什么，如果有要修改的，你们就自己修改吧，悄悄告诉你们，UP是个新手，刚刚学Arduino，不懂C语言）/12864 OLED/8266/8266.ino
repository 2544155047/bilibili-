...
const char* ssid = "Mi_Small_Pink_Pig";  //bazhegaile
const char* password = "13851205939";
...
void loop() {
  ...
  if(WiFi.status() == WL_CONNECTED){
    HTTPClient http;
    http.begin("https://api.bilibili.com/x/relation/stat?vmid=160947003");  //zhe de UID gai cheng ni de
